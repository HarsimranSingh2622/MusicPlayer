//define variables
let audio, platbtn, title,poster, artists, mutebtn, seekslider, volumeslider,
...
title=["Cartoon-On-&-O","Elektronomia","Fearless", "Johnning", "Popsicle"];

artists=["Daniel Levi","Sky High","Tule", "Janji", "Karan"];
